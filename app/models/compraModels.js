...
const filtrarCompra = async (body)=>{
    ...
    [
        ...
        null, 
        null, 
        moment(body.fechaInicio,'DD-MM-YYYY').startOf('day').format('YYYY-MM-DD HH:mm:ss'),
        moment(body.fechaFin,'DD-MM-YYYY').endOf('day').format('YYYY-MM-DD HH:mm:ss'),
        null,
        null,
        'reporteComprasPorFecha',
        body.sesId
...
const filtrarCompra2 = async (body)=>{
    ...
    [
        ...
        null, 
        moment(body.fechaInicio,'DD-MM-YYYY').startOf('day').format('YYYY-MM-DD HH:mm:ss'),
        moment(body.fechaFin,'DD-MM-YYYY').endOf.format('YYYY-MM-DD HH:mm:ss'),
        null,
        null,
        'reporteComprasPorFechaDesagregado',
        body.sesId
