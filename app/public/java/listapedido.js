...
async function vistaListapedido(){
	bloquea();
	let tabla="pedido";

	pedidos= await axios.get('/api/'+tabla+'/inicio/listar/'+verSesion()+"/reportePedidosPorFecha",{
		headers: 
		{ 
			...
			<div class="card card-primary">
				<div class="card-body">
					<div id="${tabla}" class="needs-validation" novalidate>
						...
						<div class="card-header tx-medium bd-0 tx-white bg-primary-gradient py-1"><i class="las la-shopping-cart"></i> LISTA DE PEDIDOS</div>
					</div>
                    <div class="row">
                        <div class="col-12">
