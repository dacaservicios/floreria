...
const {buscar,listar,listarDetalle,listarHistorial,listarInicio, crear, editar, estado,estado2,buscarDetalle, crearDetalle,editarDetalle, eliminarDetalle, listarPago, pagar, buscarPago,eliminarPago, eliminar, documento,buscarTotales} = require('../controllers/pedidoControllers');
...
router.put('/api/pedido/estado2/:id', verificarToken, estado2);
...
router.get('/api/pedido/historial/listar/:id/:sesId', verificarToken, listarHistorial);
